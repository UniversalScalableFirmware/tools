...
def main():
    ...
    parser.add_argument('-x64',  '--arch64',      action='store_true', help='Bootloader hand-off to payload in 64bit, by default in 32bit.')
    ...
    if args.coreboot:
        ...
        clone_repo ('https://github.com/universalpayload/slimbootloader.git', 'universal_payload', 'slimbootloader', work_dir)

    clone_repo ('https://github.com/universalpayload/edk2.git', 'universal_payload', 'edk2', work_dir)
